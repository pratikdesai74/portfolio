...
const journeyStops: JourneyStop[] = [
  {
    ...
    year: "2014",
    title: "The Origin",
    subtitle: "Engineering Graduate - Shivaji University",
    description: "Completed BE/B.Tech from Shivaji University, Kolhapur. Built a strong foundation in problem-solving and analytical thinking.",
