...
const journeyStops: JourneyStop[] = [
  {
    ...
    description: "Started the journey from a non-tech background. Little did anyone know this mechanical engineer would become a software architect.",
    icon: <GraduationCap className="w-8 h-8" />,
    color: "#22c55e",
    achievements: ["Engineering Degree", "Problem-Solving Foundation", "First Steps"],
  },
  {
    id: 2,
    year: "2017",
    title: "The Pivot",
    subtitle: "CDAC ACTS Pune",
    description: "Made the bold decision to pivot into tech. Intense training in software development opened doors to a new world.",
    icon: <Code className="w-8 h-8" />,
    color: "#3b82f6",
    achievements: ["PG Diploma", "Java Mastery", "New Beginning"],
  ...
  },
  {
    ...
    year: "2018",
    title: "First Victory",
    subtitle: "Volante Technologies",
    description: "Landed first tech role in fintech. Built payment processing systems and won the prestigious IBS Fintech Innovation Award.",
    icon: <Trophy className="w-8 h-8" />,
    color: "#f59e0b",
    achievements: ["IBS Award Winner", "Payment Systems", "First Enterprise Role"],
    techStack: ["Java", "Spring", "Payment APIs"],
  },
  {
    id: 4,
    year: "2019",
    ...
    description: "Joined as founding engineer and built the entire platform from scratch. Scaled to $66K/mo revenue and 50+ enterprise clients.",
    icon: <Rocket className="w-8 h-8" />,
    color: "#8b5cf6",
    achievements: ["Founding Engineer", "$66K/mo Revenue", "50+ Clients"],
    techStack: ["Java", "Spring Boot", "AWS", "Kafka", "PostgreSQL"],
  },
  {
    id: 5,
    year: "2021",
    ...
    subtitle: "Mastercard",
    description: "Entered the world of global payments. Built systems processing 10M+ daily transactions at massive scale.",
    icon: <Star className="w-8 h-8" />,
    color: "#ef4444",
    achievements: ["10M+ Transactions", "Global Impact", "Hackathon Winner"],
    techStack: ["Java", "Microservices", "Kafka", "Kubernetes"],
  },
  {
    id: 6,
    year: "2023",
    title: "Security Chapter",
    subtitle: "Securonix - Senior Engineer",
    description: "Currently securing enterprises with cutting-edge cybersecurity solutions. Building UEBA platform serving 1000+ companies.",
    icon: <Shield className="w-8 h-8" />,
    color: "#06b6d4",
    achievements: ["1000+ Enterprises", "Cybersecurity", "Team Lead"],
    techStack: ["Java", "Spring Boot", "Kafka", "Security", "ML"],
  },
];
